        				...
        				<form class="form" role="form" method="post" action="gerenciarClienteModel.php">
        					...
        					<br>
        				   	...
        				   	<div class="input-group textos">
								<input type="Jaqueta" id="Jaqueta" style="width:260px"; name="nome" value= "" class="form-control" placeholder="Nome Jaqueta" required autofocus >
							</div>
							<br>
        				   <label for="textos">Tecido:</label>
        				   <div class="input-group textos">
        				   	<input type="text" id="Tecidofone" name="Tecido" value= "" class="form-control" placeholder="Tecido" required  >
        				   </div>
        				   <br>
        				   <label for="textos">Valor:</label>
        				   <div class="input-group telefone">
        				   	<input type="text" id="marca" name="valor" value= "" class="form-control" placeholder="Valor" required  >
        				   </div>
        				   <br>
